...
from restaurant.models import (
    ...
    Table, Status_Table, Order, Status_Order, OrderDetail,
    Review, Rating, FoodChef, Reservation
)
...
FoodIngredient.objects.get_or_create(food=f1, ingredient=ing1, defaults={'notes': '5 medium tiger prawns'})
FoodIngredient.objects.get_or_create(food=f1, ingredient=ing2, defaults={'notes': '50g sliced boiled pork'})
FoodIngredient.objects.get_or_create(food=f1, ingredient=ing3, defaults={'notes': 'Adequate rice vermicelli'})
FoodIngredient.objects.get_or_create(food=f1, ingredient=ing4, defaults={'notes': 'Lettuce and basil leaves'})
FoodIngredient.objects.get_or_create(food=f2, ingredient=ing2, defaults={'notes': '100g minced pork'})
FoodIngredient.objects.get_or_create(food=f2, ingredient=ing5, defaults={'notes': '20g soaked wood ear mushrooms'})
FoodIngredient.objects.get_or_create(food=f2, ingredient=ing6, defaults={'notes': '30g soaked and chopped glass noodles'})
FoodIngredient.objects.get_or_create(food=f6, ingredient=ing7, defaults={'notes': '100g rare and well-done beef slices'})
FoodIngredient.objects.get_or_create(food=f6, ingredient=ing8, defaults={'notes': 'Bone broth simmered for 12 hours'})
FoodIngredient.objects.get_or_create(food=f6, ingredient=ing3, defaults={'notes': 'Fresh flat rice noodles'})
FoodIngredient.objects.get_or_create(food=f7,  ingredient=ing9,  defaults={'notes': '200g catfish fillet'})
FoodIngredient.objects.get_or_create(food=f12, ingredient=ing7,  defaults={'notes': '200g minced beef'})
FoodIngredient.objects.get_or_create(food=f12, ingredient=ing10, defaults={'notes': '20 fresh wild pepper leaves'})
...
o1, created1 = Order.objects.get_or_create(
    table=t3, status_order=Status_Order.SUCCESS,
...
o2, created2 = Order.objects.get_or_create(
    table=t5, status_order=Status_Order.SUCCESS,
...
o3, created3 = Order.objects.get_or_create(
    table=t6, status_order=Status_Order.SUCCESS,
...
o4, created4 = Order.objects.get_or_create(
    table=t7, status_order=Status_Order.SUCCESS,
...
o5, created5 = Order.objects.get_or_create(
    table=t8, status_order=Status_Order.SUCCESS,
